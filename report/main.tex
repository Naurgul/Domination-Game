...
\bibitem{domination} Domination Game Website [New Framework]. Written by Thomas van den Berg and Tim Doolan. Available at: https://github.com/noio/Domination-Game/
...
\bibitem{continuous} H. Hasselt, \emph{Reinforcement Learning in Continuous State and Action Spaces}, RL-Sota chapter 7
\bibitem{decpomdp} F.A. Oliehoek, \emph{Decentralized POMDPs}, RL-Sota chapter 15
\bibitem{gameth} A. Nowe´, P Vrancx, Y. De Hauwere, \emph{Game Theory and Multi-agent Reinforcement Learning}, RL-Sota chapter 14
\end{thebibliography}
